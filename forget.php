...
<div class="login-form">
	...
	<?php
        if(isset($_GET['pay'])){
          $p=$_GET['pay'];
            echo '<div class="alert alert-danger"><strong>Mohon Maaf!</strong> Akun anda telah diblokir karena periode pemakaian sudah habis, silahkan membayar sebesar <b>'.$p.'</b> ke rekening kami yang bisa anda lihat pada <a href="#sk" data-toggle="modal">Syarat & Ketentuan</a> kami.</div>';
        ...
        if(isset($_GET['pin'])){
          if ($_GET['pin'] == 'no'){
            echo '<div class="alert alert-danger" id="aa">Pin yang anda masukkan salah, silahkan ulangi kembali.</div>';
          }
        }   
  ?>
    	
    
<div class="alert alert-info">Anda harus <b style="color:red;">terhubung dengan internet</b>, 8 digit pin akan dikirimkan melalui email anda secara otomatis</div>
    <form action="cek.php?lupa=yes" method="post">
