...
<div class="login-form">
  ...
  <p style="font-size: 60px; color: red"><i class="fa fa-warning"></i> 404</p>
  <p>Mohon maaf, halaman yang anda minta tidak tersedia</p><br>
  <button onclick="goBack()" class="btn btn-primary"><span class="fa fa-chevron-left"></span> Kembali</button>
   <a href="#cn" data-toggle="modal" class="btn btn-default"><span class="glyphicon glyphicon-envelope" ></span> Hubungi Kami</a>
  <form>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>3. Jika sudah memasuki H-5 sebelum masa aktif habis, maka akan muncul pemberitahuan tagihan yang harus dibayarkan pada fitur cek status, paket yang disediakan bersifat <b style="color:red">Unlimited</b> atau <b style="color:red">Bebas Kuota</b>, dan besarnya tagihan setiap paket adalah sebagai berikut : <br><b>512K = Rp100.000,-</b><br><b>1M = Rp125.000,-</b><br><b>2M = Rp175.000,-</b><br></p>
...
<div id="cn" class="modal fade" role="dialog">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Kontak admin via Whatsapp <i class="fa fa-whatsapp fa-fw"></i> 085852924304 atau email <i class="fa fa-envelope fa-fw"></i> galeh.fatma@gmail.com</p>
      </div>
    </div>
